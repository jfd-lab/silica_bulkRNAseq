...
# --- Bouchet/mouse paths ---
output.dir<-"/nfs/roberts/scratch/pi_epm38/jfd42/silica_RV/results_Rsubread_GRCm39"
tophat.dir<-"/nfs/roberts/scratch/pi_epm38/jfd42/silica_RV/results_STAR_GRCm39"
