...
home.dir<-"/nfs/roberts/scratch/pi_epm38/jfd42/silica"
...
```{r}
# Run on HPC
result.dir<-"/nfs/roberts/scratch/pi_epm38/jfd42/silica/results_FastQC"
...
source("/nfs/roberts/project/pi_epm38/jfd42/pipelines/Xiting_bulkRNA_FastQtoCounts/my_functions.R")
result.dir<-"/nfs/roberts/scratch/pi_epm38/jfd42/silica/results_FastQC"
output.filepath<-"/nfs/roberts/scratch/pi_epm38/jfd42/silica/FastQC_results_table.txt"
sample.names<-list.files(result.dir)
cmd.out<-data.frame()
