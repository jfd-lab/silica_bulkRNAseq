...
data.dir<-"/nfs/roberts/project/pi_epm38/jfd42/silica/plasmidsaurus_SS8VZG_raw_data/FASTQ_files/lung"
...
```{r}
result.dir<-"/nfs/roberts/scratch/pi_epm38/jfd42/silica/results_fastqc_2"
...
source("/nfs/roberts/project/pi_epm38/jfd42/pipelines/Xiting_bulkRNA_FastQtoCounts/my_functions.R")
result.dir<-"/nfs/roberts/scratch/pi_epm38/jfd42/silica/results_fastqc_2"
output.filepath<-"/nfs/roberts/scratch/pi_epm38/jfd42/silica/FastQC_results_table_2.txt"
sample.names<-list.files(result.dir)
cmd.out<-data.frame()
