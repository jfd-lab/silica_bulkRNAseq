...
count.dir<-"/nfs/roberts/scratch/pi_epm38/jfd42/silica/results_Rsubread_GRCm39"
output.filepath<-"/nfs/roberts/scratch/pi_epm38/jfd42/silica/rawcounts_GRCm39.txt"
